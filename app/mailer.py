...
# Every email this app sends is BCC'd to Kalyan for visibility (Batch C
# decision, 2026-09-15) - invisible to the actual recipient.
BCC_ADDR = "kalyan@req2qa.com"
...
def send_email(to_addr: str, subject: str, body_text: str) -> tuple[bool, str]:
    ...
    msg["To"] = to_addr
    if to_addr.strip().lower() != BCC_ADDR.lower():
        msg["Bcc"] = BCC_ADDR
