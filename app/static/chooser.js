(function(){
  ...
  function showPanel(name){
    ...
    // Scroll the now-visible form into view instead of jumping to the very
    // top of the page - the chooser (and the form panels it swaps in) sits
    // well below the hero, so scrolling to (0,0) left the revealed form
    // below the fold and looked like the click had done nothing.
