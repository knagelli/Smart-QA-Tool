...
# Raised from 30 (2026-09-14) - Phase B moved execution off the synchronous
# request/response cycle, so a longer-running test case no longer risks a
# platform request timeout the way it would have before. Still a hard cap,
# just a more realistic one for legitimate multi-page flows (e.g. search,
# then open a record, then verify several fields) that need more than a
# handful of actions even when nothing is going wrong.
MAX_AGENT_STEPS = 45
