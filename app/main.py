...
async def execute_run(
    ...
    for tc_id in scheduled_ids:
        ...
        if role and role[0] == "requires":
            ...
            if fixture is None:
                ...
                working_tc["steps"] = fixtures.substitute_fixture_placeholders(tc.get("steps", ""), ftype, fixture)
                working_tc["precondition"] = fixtures.substitute_fixture_placeholders(tc.get("precondition", ""), ftype, fixture)
    ...
    return templates.TemplateResponse(request, "execute_result.html",
        {
