...
def _current_year() -> str:
    # Melbourne time, consistent with every other timestamp shown to
    # clients (see MELBOURNE_TZ in main.py) - matters only around New Year's
    # in practice, but keeps the whole app on one consistent clock.
